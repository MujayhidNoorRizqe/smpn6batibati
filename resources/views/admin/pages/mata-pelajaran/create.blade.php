                    ...
                    <form action="{{ route($routePrefix . '.mata-pelajaran.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">
                                Kode mata pelajaran wajib diisi dan akan disimpan dalam huruf besar.
                            </small>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a
                                ...
                                data-confirm="true"
                                data-confirm-message="Batalkan tambah mata pelajaran? Data yang belum disimpan akan hilang."
                            ...
                            <button
                                ...
                                data-confirm="true"
                                data-confirm-message="Apakah Anda yakin ingin menyimpan data mata pelajaran ini?"

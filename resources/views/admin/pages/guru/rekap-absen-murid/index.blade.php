...
@section('title', 'Rekap Absen Murid')

@section('content')
<div class="page-content">
    <div class="page-header-card">
        <div>
            <h1>Rekap Absen Murid</h1>
    ...
    <div class="card">
        <div class="card-header">
            <div>
                <h2>Filter Rekap Absen Murid</h2>
                <p>Pilih filter terlebih dahulu untuk mencari kelas yang ingin direkap.</p>
            </div>
        </div>

        <form method="GET" action="{{ route('guru.rekap-absen-murid.index') }}" class="filter-grid">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('guru.rekap-absen-murid.index') }}" class="btn btn-outline">
                    Reset
                </a>
            </div>
        </form>
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    ...
                    <p>Berikut kelas yang sesuai dengan filter rekap absensi.</p>
                </div>
                        ...
                        <div class="kelas-card">
                            ...
                            <div class="kelas-info-grid">
                                ...
                                <div>
                                    ...
                                    <strong>{{ $kelasItem->total_jadwal ?? 0 }}</strong>
                                </div>

                                <div>
                                    <span>Total Absensi</span>
                                    <strong>{{ $kelasItem->total_absensi ?? 0 }}</strong>
                                </div>
                            </div>
                            ...
                            <div class="status-grid">
                                <div>
                                    <span>Hadir</span>
                                    <strong>{{ $kelasItem->hadir ?? 0 }}</strong>
                                </div>

                                <div>
                                    <span>Izin</span>
                                    <strong>{{ $kelasItem->izin ?? 0 }}</strong>
                                </div>

                                <div>
                                    <span>Sakit</span>
                                    <strong>{{ $kelasItem->sakit ?? 0 }}</strong>
                                </div>

                                <div>
                                    <span>Alpha</span>
                                    <strong>{{ $kelasItem->alpha ?? 0 }}</strong>
                                </div>

                                <div>
                                    <span>Terlambat</span>
                                    <strong>{{ $kelasItem->terlambat ?? 0 }}</strong>
                                </div>
                            </div>
